...
?>
	...
	<div class="home">
		...
		<div class="home_background parallax_background parallax-window" data-parallax="scroll" data-image-src="images/fondos/bach.png" data-speed="0.8"></div>
		<div class="home_container">
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title" style="line-height : 75px;"><b style="font-size: 50px; color: rgba(255,255,255,0.5);">Coro</b>  <br> <b style="font-size: 100px; color: rgba(255,255,255,0.5);">Johann Sebastian Bach</b></div>
