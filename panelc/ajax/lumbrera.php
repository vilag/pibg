			...
			while ($reg = $rspta->fetch_object())
					{
							...
							<div style="width: 90%; float: left;">
								...
								<div style="width: 100%;">
									...
									<div style="width: 40%; float: left; padding: 5px 15px;">
										<div style="width: 100%;">
											<b style="font-size: 20px;">'.$reg->nombre.'</b>
										</div>
						...
						echo '
									...
									<div style="margin-top: 30px; width: 20%; float: left; padding: 5px 10px; border-right: #cccccc 1px solid; height: 60px; padding-top: 20px; text-align: center;">
										<a style="font-size: 12px; border: #ccc 1px solid; border-radius: 10px; box-shadow: 5px 5px 10px rgba(0,0,0,0.2); padding: 9px; width: 25%; border-radius: 5px; background-color: #1F4168; color: #fff;" href="#modal_archivo_voz" onclick="subir_doc_voz_modal('.$reg->idvoz.',\''.$reg->nombre.'\')">Nueva partitura</a>		
									</div>
								</div>
							</div>
							...
							<div style="width: 10%; float: left; padding-top: 35px;">
								...
								<div style="width: 100%; float: left; height: 50px; display: flex; justify-content:  center; align-items: center;">
									<button style="background-color: transparent; border: none;"><a style="padding: 9px; width: 25%; border-radius: 5px;" href="#modal2" onclick="editar_voz('.$reg->idvoz.',\''.$reg->nombre.'\',\''.$reg->enlace.'\')"><img src="images/iconos/editar2.png" alt="" style="width: 20px;"></a></button>
