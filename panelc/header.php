    ...
    <div class="container-scroller">
          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item nav-profile dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
                ...
                <a class="dropdown-item" href="ajax/usuario.php?op=salir">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="semanas_esp.php">
              <img src="images/iconos/calendar.png" style="width: 25px; margin-right: 14px; margin-left: -3px;" alt="">
              <span class="menu-title">Semanas Especiales</span>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="peticiones.php">
              ...
              <span id="badge_peticiones" style="display:none;background:#dc3545;color:#fff;border-radius:10px;padding:1px 7px;font-size:11px;margin-left:6px;font-weight:700;"></span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="academia_solicitudes.php">
              <img src="images/iconos/list_b.png" style="width: 25px; margin-right: 14px; margin-left: -3px;" alt="">
              <span class="menu-title">Academia Coré</span>
              <span id="badge_academia_solicitudes" style="display:none;background:#dc3545;color:#fff;border-radius:10px;padding:1px 7px;font-size:11px;margin-left:6px;font-weight:700;"></span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="codigos_qr.php">
              <img src="images/iconos/list_b.png" style="width: 25px; margin-right: 14px; margin-left: -3px;" alt="">
          ...
          <li class="nav-item">
            <a class="nav-link" href="mis_notificaciones.php">
              <img src="images/iconos/list_b.png" style="width: 25px; margin-right: 14px; margin-left: -3px;" alt="">
              <span class="menu-title">Mis notificaciones</span>
            </a>
          </li>
          <li class="nav-item">
