          ...
          <div class="bp-toolbox">
            ...
            <div class="bp-tool-group" id="bp_panel_objeto" style="display:none;">
              ...
              <div id="bp_grupo_texto">
                <div class="bp-obj-row">
                  <select class="form-control" id="bp_obj_fontfamily" onchange="cambiar_fuente_obj(this.value)" title="Tipo de letra" style="font-size:14px;">
                    ...
                    <option value="Playfair Display" style="font-family:'Playfair Display';">Playfair Display (serif elegante)</option>
